    ...
    def _packet_in_handler(self, ev):
        ...
        if pkt_arp:
            ...
            mypkt.add_protocol(arp.arp(
                # src_mac=self.ip2mac[pkt_arp.dst_ip], # 根据dst_ip得到的mac, # need
                # to know the ip asked
        ...
        # IPV4
            ...
            # TCP
                ...
                if pkt_tcp.dst_port == 8080 and (
                        src == '10:00:00:00:00:02' or src == '10:00:00:00:00:04'):
            ...
            # UDP
                ...
                if src != '10:00:00:00:00:01' and src != '10:00:00:00:00:04':
                    ...
                    print(
                        ...
                        "tcp_src:",
                        pkt_udp.src_port)
                    out_port = self.couter_clockwise_outport(
                        dpid, src, dst)  # icmp go clockwise
                    # pattern for match
                    match = parser.OFPMatch(eth_type=0x0800,  # IP
                                            ip_proto=17,  # udp
